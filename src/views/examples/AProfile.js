...
function AProfile() {
        ...
        <div className="wrappers"> 
          ...
          <div className="profile-card js-profile-card">
            ...
            <div className="profile-card__cnt js-profile-cnt">
              ...
              <div className="profile-card__txt">Singing genres <strong>pop music</strong></div>
              <div className="profile-card-loc">
                <span className="profile-card-loc__icon">
                  <svg className="icon-apo"><use xlinkHref="#icon-location" /></svg>
                </span>
              ...
              <div className="profile-card-inf">
                ...
                <div className="profile-card-inf__item">
                  ...
                  <div className="profile-card-inf__txt">Feeds</div>
                </div>
              </div>
              <div className="profile-card-social">
                <a href="" className="profile-card-social__item facebook" target="_blank">
                  <span className="icon-font">
                    <svg className="icon-apo"><use xlinkHref="#icon-facebook" /></svg>
                  </span>
                </a>
                <a href="" className="profile-card-social__item twitter" target="_blank">
                  <span className="icon-font">
                    <svg className="icon-apo"><use xlinkHref="#icon-twitter" /></svg>
                  </span>
                </a>
                <a href="" className="profile-card-social__item instagram" target="_blank">
                  <span className="icon-font">
                    <svg className="icon-apo"><use xlinkHref="#icon-instagram" /></svg>
                  </span>
                </a>
                
                <a href="" className="profile-card-social__item codepen" target="_blank">
                  <span className="icon-font">
                    <svg className="icon-apo"><use xlinkHref="#icon-codepen" /></svg>
                  </span>
                </a>
                <a href="" className="profile-card-social__item link" target="_blank">
                  <span className="icon-font">
                    <svg className="icon-apo"><use xlinkHref="#icon-link" /></svg>
                  </span>
                </a>
              </div>
              <div className="profile-card-ctr">
                <button className="profile-card__button button--blue js-message-btn">About</button>
   ...
   <Row>
<Col lg="3" md="4" sm="4" xm="4">
    
    <div class="cards-list cardmag">
  <div class="card-sng 2">
